...
const DEFAULT_PORTIONS = [
  ...
  { terms: ['gemuese', 'vegetables', 'veggies'], food: { name: 'Gemuese', per: 100, unit: 'g', energy: 35, protein: 2, fat: 0, carb: 7 }, grams: 150 },
  { terms: ['kaese', 'cheese'], food: { name: 'Kaese', per: 30, unit: 'g', energy: 120, protein: 7, fat: 10, carb: 1 }, grams: 30 },
  { terms: ['olivenol', 'olive oil', 'oel', 'oil'], food: { name: 'Olivenoel', per: 10, unit: 'g', energy: 90, protein: 0, fat: 10, carb: 0 }, grams: 10 },
